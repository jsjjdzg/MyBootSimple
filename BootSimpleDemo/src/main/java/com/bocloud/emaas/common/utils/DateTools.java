...
import com.bocloud.emaas.common.model.Week;
/** 
 * 日期相关工具类，用于日期和字符串之间的相互转化
 * @author dmw
 *
 */
 ...
 * @return
 */
	public static Week getWeekOfOneDay(Date date){
	...
	public static int getJob(Date startTime,Date endTime){
		Long nu=endTime.getTime()-startTime.getTime();
		int num=(int) (nu/(1000 * 60 * 60 * 24));
		Calendar c = Calendar.getInstance();
		c.setTime(startTime);
